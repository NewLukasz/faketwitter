...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToOne(mappedBy: 'base_user', cascade: ['persist', 'remove'])]
    ...
    #[ORM\JoinTable('followers')] //for change table name
    ...
    public function setUserProfile(UserProfile $userProfile): static
    {
        ...
        if ($userProfile->getBaseUser() !== $this) {
            $userProfile->setBaseUser($this);
        }
